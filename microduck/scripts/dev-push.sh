...
cargo run -p xtask -- package \
    ...
    --include "example_policies/alpha_walking.onnx=policies/alpha_walking.onnx" \
    --include "example_policies/alpha_stand.onnx=policies/alpha_stand.onnx" \
    --include "example_policies/alpha_sitstand.onnx=policies/alpha_sitstand.onnx" \
    --include "example_policies/alpha_ground_pick.onnx=policies/alpha_ground_pick.onnx" \
    --include "example_policies/ball_kick_left.onnx=policies/ball_kick_left.onnx" \
    --include "example_policies/ball_kick_right.onnx=policies/ball_kick_right.onnx" \
    --include "example_policies/roller.onnx=policies/roller.onnx" \
    --include "example_policies/roller_crouch.onnx=policies/roller_crouch.onnx" \
    --include "example_policies/roulade.onnx=policies/roulade.onnx" \
